...
public class JacobUtil {
	...
	public static void main(String[] args) {
		...
		int time = convert2PDF("C:\\Users\\renlg\\Desktop\\test.ppt", "C:\\Users\\renlg\\Desktop\\test.pdf");
	 ...
	 * @param pdfFile
	 */
	public static void conver2Pdf(String inputFile, String pdfFile) {
		File parentFile = new File(pdfFile).getParentFile();
	...
	private static int convert2PDF(String inputFile, String pdfFile) {
		...
		if (kind.equals("doc") || kind.equals("docx") || kind.equals("txt")) {
			return JacobUtil.word2PDF(inputFile, pdfFile);
		} else if (kind.equals("ppt") || kind.equals("pptx")) {
			return JacobUtil.ppt2PDF(inputFile, pdfFile);
		} else if (kind.equals("xls") || kind.equals("xlsx")) {
			return JacobUtil.Ex2PDF(inputFile, pdfFile);
		} else {
			return -4;
		}
	}
